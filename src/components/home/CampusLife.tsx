...
// 			{/* First section: Dark overlay with content */}
...
// 			{/* Second section: Parallax image section */}
...
// 						height: '80', // Taller than container to allow movement
// 						top: '-25%', // Start above container to allow for parallax effect
// 					}}
// 				/>
// 				{/* Optional overlay for better text visibility if needed */}
// 				{/* <div className='absolute inset-0 bg-black bg-opacity-30'></div> */}

// 				{/* Optional: Add text or content overlaying the parallax image */}
...
// 			{/* Third section: Content section below parallax */}
...
// 							<h4 className='text-xl font-bold mb-3'>Student Clubs</h4>
// 							<p>
...
// 						</div>
// 						<div className='bg-gray-800 bg-opacity-70 p-6 rounded-lg'>
// 							<h4 className='text-xl font-bold mb-3'>Sports & Recreation</h4>
// 							<p>
...
// 						</div>
// 						<div className='bg-gray-800 bg-opacity-70 p-6 rounded-lg'>
// 							<h4 className='text-xl font-bold mb-3'>Arts & Culture</h4>
// 							<p>
...
// 							Our residence halls offer more than just a place to sleep—they're
// 							communities where friendships form and memories are made.
// 						</p>
// 					</div>
// 				</div>
// 			</div>
...
// 						top: '-15%', // Start slightly above to allow for parallax effect
// 					}}></div>

// 				{/* Text overlay on the parallax image */}
// 				{/* <div className='relative z-10 h-full flex items-center justify-center'>
// 					<div className='text-center text-white px-4'>
// 						<h3 className='text-3xl md:text-4xl font-bold mb-4 text-shadow'>
// 							Experience Campus Life
// 						</h3>
// 						<p className='text-xl max-w-lg mx-auto text-shadow'>
// 							Where memories are made and futures begin
// 						</p>
// 					</div>
// 				</div> */}
		...
		<div className='relative'>
			...
			<div className='relative z-20 bg-gray-900 text-white'>
				<div className='container mx-auto px-6 py-24'>
					...
					{/* <div className='grid grid-cols-1 md:grid-cols-3 gap-8 mb-16'>
						<div className='bg-gray-800 bg-opacity-70 p-6 rounded-lg hover:bg-opacity-90 transition-all duration-300'>
							<h4 className='text-xl font-bold mb-3'>Student Clubs</h4>
							<p>
								Join diverse communities of like-minded individuals pursuing
								their passions together.
