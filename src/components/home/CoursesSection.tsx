...
function CoursesSection() {
	...
	return (
		...
		<motion.div
			...
			className='relative z-20 bg-gradient-to-b from-white to-blue-50 text-gray-800'>
			{/* New Header Section */}
			<motion.div
				variants={itemVariants}
				className='bg-blue-900 text-white py-16 md:py-20'>
			...
			<div className='container mx-auto px-4 sm:px-6 py-16 sm:py-20 md:py-24'>
				...
				<motion.div
					...
					<Link
						...
						<motion.span variants={buttonVariants} className='mr-2'>
							View All Programs
						</motion.span>
